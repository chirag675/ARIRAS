...
POLICY_PROMPT = PromptTemplate(
    ...
    template="""
You are GovernIQ — a senior compliance advisor helping an Indian company understand
...
def build_excel(guidance: dict) -> bytes:
    ...
    ws1["A1"] = "GovernIQ — Compliance Policy Guidance Report"
    ...
    ws2["A1"] = "GovernIQ — Compliance Readiness Summary"
